...
contract MoodNftIntegrationTest is Test {
    ...
    function testFlipTokenToSad() public {
        ...
        assert(keccak256(abi.encodePacked(SAD_SVG_URL)) == keccak256(abi.encodePacked(moodNft.tokenURI(0))));
    }
}